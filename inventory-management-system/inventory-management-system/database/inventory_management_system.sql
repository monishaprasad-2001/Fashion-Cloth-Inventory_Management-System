...
INSERT INTO `customers_fc` (`id`, `Name`, `PhoneNumber`) VALUES
...
INSERT INTO `products_fc` (`id`, `item_number`, `item_group`, `quantity`, `price`) VALUES
...
INSERT INTO `purchase_fc` (`id`, `invoice`, `shop and address`, `total_items`, `total_amount`, `date_of_purchase`) VALUES
...
INSERT INTO `users_fc` (`id`, `username`, `password`) VALUES
(1, 'admin', 'admin');
...
--
ALTER TABLE `sales`
  ADD CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`cust_id`) REFERENCES `customers_fc` (`id`);
COMMIT;
