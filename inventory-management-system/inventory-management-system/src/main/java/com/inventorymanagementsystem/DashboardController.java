...
public class DashboardController implements Initializable {
    ...
    public List<Product> getItemsList(){
        ...
        String sql="SELECT * FROM PRODUCTS_FC";
        try{
    ...
    public boolean saveCustomerDetails(){
        ...
        connection = Database.getInstance().connectDB();
        String sql="SELECT * FROM customers_fc WHERE phonenumber=?";
        try {
            preparedStatement = connection.prepareStatement(sql);
            ...
            if (resultSet.next()) {
                ...
                String customerSql="INSERT INTO customers_fc(name,phonenumber) VALUES(?,?)";
    ...
    public void saveInvoiceDetails(){
        ...
        connection=Database.getInstance().connectDB();
        String sql="SELECT id FROM customers_fc WHERE PHONENUMBER=?";
        try{
            preparedStatement=connection.prepareStatement(sql);
            preparedStatement.setString(1,bill_phone.getText());
            resultSet=preparedStatement.executeQuery();
    ...
    public void printBill(){
     connection=Database.getInstance().connectDB();
     String sql="SELECT * FROM `sales` s INNER JOIN customers_fc c ON s.cust_id=c.id and s.inv_num=(SELECT MAX(inv_num) as inv_num FROM `sales`)";
     try{
    ...
    public ObservableList<Customer> listCustomerData(){
        ...
        connection=Database.getInstance().connectDB();
        String sql="SELECT * FROM customers_fc";
        try{
            statement=connection.createStatement();
            resultSet=statement.executeQuery(sql);
    ...
    public void addCustomerData(){
        ...
        connection=Database.getInstance().connectDB();
        String sql="INSERT INTO customers_fc(name,phonenumber)VALUES(?,?)";
        try{
            preparedStatement=connection.prepareStatement(sql);
    ...
    public void updateCustomerData(){
        ...
        connection = Database.getInstance().connectDB();
        String sql = "UPDATE customers_fc SET name=? WHERE phonenumber=?";
        try {
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.setString(1,cust_field_name.getText());
            preparedStatement.setString(2, cust_field_phone.getText());
    ...
    public void deleteCustomerData(){
        ...
        connection = Database.getInstance().connectDB();
        String sql="DELETE FROM customers_fc WHERE phonenumber=?";
        try {
            preparedStatement = connection.prepareStatement(sql);
    ...
    public ObservableList<Sales> listSalesData(){
        ...
        connection=Database.getInstance().connectDB();
        String sql="SELECT * FROM SALES s INNER JOIN customers_fc c ON s.cust_id=c.id";
        try{
            statement=connection.createStatement();
            resultSet=statement.executeQuery(sql);
            Sales sale;
    ...
    public void getTotalPurchaseAmount(){
        connection=Database.getInstance().connectDB();
        String sql="SELECT SUM(total_amount) as total_purchase_amount FROM purchase_fc";
        try{
            statement=connection.createStatement();
            resultSet=statement.executeQuery(sql);
            while (resultSet.next()){
